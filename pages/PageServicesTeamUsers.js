...
class TeamUser extends PageTemplate {
    constructor(params) {
        super();
        this.pageTitle = 'User';
        this.page = 'user';
...
<div class="container bootdey flex-grow-1 container-p-y">
            ...
            <div class="media align-items-center py-3 mb-3">
              ...
              <h4 class="font-weight-bold mb-0">${serviceObj2.name} </h4>
                <div class="text-muted mb-2">ID: 3425433</div>
                <a href="${serviceObj.href}${serviceObj2.href}/projects" class="btn btn-primary btn-sm">Projects</a>&nbsp;
